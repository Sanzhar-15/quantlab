//! `ql-sql` — Phase 2A.12 audit M16/DOC: rewrote stale "Phase 0 stub" doc.
//!
//! Reserved for Phase 6+ — SQL surface over the workbook (T1-D03 keeps Arrow as the storage substrate, so DataFusion integration is the planned path).
//!
