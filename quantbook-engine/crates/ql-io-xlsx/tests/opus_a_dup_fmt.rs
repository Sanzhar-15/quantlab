...
<cellXfs count="3">
  ...
  <xf numFmtId="165" applyNumberFormat="1"/>
        ...
        let parts: &[(&str, &str)] = &[
            ...
            ("xl/worksheets/sheet1.xml", r#"<?xml version="1.0"?><worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"><sheetData><row r="1"><c r="A1" s="1"><v>45000</v></c><c r="B1" s="2"><v>45001</v></c></row></sheetData></worksheet>"#),
    ...
    let r = import_xlsx_path(
        &src,
        &registry(),
        XlsxImportOptions { recompute: RecomputeMode::Skip, ..Default::default() },
    );
    match r {
        Ok(res) => {
            println!("import OK");
...
<cellXfs count="2">
  ...
  <xf numFmtId="164" applyNumberFormat="1"/>
        ...
        let parts: &[(&str, &str)] = &[
            ...
            ("xl/_rels/workbook.xml.rels", r#"<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/worksheet" Target="worksheets/sheet1.xml"/><Relationship Id="rId2" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/styles" Target="styles.xml"/></Relationships>"#),
            ("xl/workbook.xml", r#"<?xml version="1.0"?><workbook xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships"><sheets><sheet name="S1" sheetId="1" r:id="rId1"/></sheets></workbook>"#),
            ("xl/worksheets/sheet1.xml", r#"<?xml version="1.0"?><worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"><sheetData><row r="1"><c r="A1" s="1"><v>1</v></c></row></sheetData></worksheet>"#),
            ("xl/styles.xml", styles),
        ];
        for (n, c) in parts {
            zw.start_file(*n, opts).unwrap();
    ...
    println!("import OK; A1 overlay = {:?}", sheet.format_overlay().get(0, 0));
    println!("formats[164] = {:?}", r.workbook.formats().lookup(ql_storage::FormatId(164)));
