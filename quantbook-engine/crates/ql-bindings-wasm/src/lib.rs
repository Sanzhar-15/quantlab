...
//!
//! WebAssembly bindings for browser frontends — **v1.5-deferred** (decision-lock §2.8,
//! ratified 2026-05-30; Phase-6.7 closure). No v1 consumer: the IDE uses napi, the
//! service uses HTTP. Currently empty (no public surface).
//!
...
//! shape. Real WASM work lands in v1.5.
