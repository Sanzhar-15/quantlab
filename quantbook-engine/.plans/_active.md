...
status: in-progress (V3.4.0.1 lock at engine `a87c31eed4f`; V3.4.0.2 cache at `1ae59a1a1aa`; V3.4.0.3 undo/redo at engine `7d63ff53132` + IDE `673792af05f`; V3.4.0.5a presence engine napi at engine `5ce55f65739` + IDE `8ff2d81f1e4`; V3.4.0.5b IDE cell-grid presence integration shipped at IDE (THIS commit; no engine changes) +16 mocha (203 -> 219). V3.4.0.4 .qbook persistence is the only remaining V3.4.0 sub-step before V3.4.0.6 mocha + V3.4.0.7 docs + V3.4.0.X audit.)
date: 2026-05-23
...
current_engine_head: 5ce55f65739 (V3.4.0.5a presence napi; V3.4.0.5b had no engine changes; this commit updates the plan only)
current_ide_head: (this commit pair) V3.4.0.5b IDE -- presence integration (buildPresenceSnapshotJson + cell-grid-presence data block + .cell-peer-presence CSS + webview decoration + beginEdit/endEdit broadcast + dispatcher arm + render/dispose lifecycle + 16 tests)
current_mocha_count: 219 / 219 (V3.4.0.5b adds +16 over 203)
current_ql_collab_tests: 79 / 79 (unchanged; V3.4.0.5b is IDE-only)
