...
current_engine_head: (this commit -- V3.6.0.4 D3 per-cell + per-sheet op-index + CacheBuckets refactor + OpLog::get + rebuild_op_indices_only + invalidate_cell rewrite + 6 regression tests + R-V3.6-10 risk doc) <- 9d6bae96100 (V3.6.0.X audit-of-D2 MASTER-PLAN sweep) <- 8480f247aea (V3.6.0.X audit-of-D2 closures) <- 0c3cbef8cea (V3.6.0.3 docs sweep) <- ffa598a1c15 (V3.6.0.3 D2) <- 08964962cf8 (V3.6.0.X audit-closure of V3.6.0.2) <- 89f5a5f9e0b (V3.6.0.2 D1) <- 4fd816ded43 (V3.6.0.1 lock)
current_ide_head: 21fe6a73ec6 (V3.6.0.X audit-of-D2 IDE typedoc sweep; unchanged by V3.6.0.4 D3 -- D3 is engine-internal, no napi shape change)
current_mocha_count: 350 / 350 (unchanged at V3.6.0.4 D3 ship; cell_op_index + sheet_op_index are engine-internal, IDE doesn't observe them)
current_ql_collab_tests: 130 / 130 (V3.5 cumulative +34 + V3.6 cumulative +15: V3.6.0.2 +0 (2 V3.5 tests rewritten) + V3.6.0.X audit-closure-of-V3.6.0.2 +2 + V3.6.0.3 D2 +2 + V3.6.0.X audit-of-D2 closure +5 + V3.6.0.4 D3 +6)
...
- V3.6.0.X audit of D3 (V3.6.0.4 ship): per-cell op-index sync invariant + perf comparison.
