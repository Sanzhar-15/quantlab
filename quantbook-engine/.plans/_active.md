...
status: in-progress (V3.3.0.1 + V3.3.0.2 + V3.3.0.3 + V3.3.0.4 all shipped.  V3.3.0.4 added custom-inline virtualization scaffold (computeVisibleRange + buildVirtualRows pure helpers; viewport/spacer rows; snapshot data block; scroll-driven repaint with mid-edit guard).  IDE `570c890f654`; mocha 149 -> 167 (+18).  V3.3.0.5 IDE multi-sheet UX command is the next sub-step.)
date: 2026-05-22
...
current_engine_head: 2bfba9b55ec (V3.3.0.3 engine exportSnapshot incremental cache; V3.3.0.4 had no engine changes)
current_ide_head: 570c890f654 (V3.3.0.4 IDE virtualization scaffold; predecessor 68b32bc5ad1 = V3.3.0.3 cache tests)
current_mocha_count: 167 / 167 (V3.2 exit baseline 140 + V3.3.0.2 +5 + V3.3.0.3 +4 + V3.3.0.4 +18)
