...
current_engine_head: (this commit -- V3.6.0.X audit-of-D3 closures: invalidate_cell atomic-swap + rebuild_op_indices_only via apply_cache_effect + cell_op_index pruned on RemoveSheet + poll_remote_with_limit partial-error rebuild + OpLog::get docstring correction + 4 regression tests + ide-consumer-contract sweep) <- 84cb5c9d169 (V3.6.0.4 D3 MASTER-PLAN sweep) <- 119df9b3826 (V3.6.0.4 D3 ship) <- 9d6bae96100 (V3.6.0.X audit-of-D2 MASTER-PLAN sweep) <- 8480f247aea (V3.6.0.X audit-of-D2 closures) <- 0c3cbef8cea (V3.6.0.3 docs sweep) <- ffa598a1c15 (V3.6.0.3 D2)
current_ide_head: 21fe6a73ec6 (unchanged; V3.6.0.X audit-of-D3 closures are engine-internal)
current_mocha_count: 350 / 350 (unchanged; D3 + audit-of-D3 closures are engine-internal)
current_ql_collab_tests: 134 / 134 (V3.5 cumulative +34 + V3.6 cumulative +19: V3.6.0.2 +0 (2 V3.5 tests rewritten) + V3.6.0.X audit-closure-of-V3.6.0.2 +2 + V3.6.0.3 D2 +2 + V3.6.0.X audit-of-D2 closure +5 + V3.6.0.4 D3 +6 + V3.6.0.X audit-of-D3 closure +4)
