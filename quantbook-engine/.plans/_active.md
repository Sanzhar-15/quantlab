...
status: in-progress (V3.3.0.1 + V3.3.0.2 + V3.3.0.3 + V3.3.0.4 + V3.3.0.5 all shipped.  V3.3.0.5 added multi-sheet UX command (quantbookCellGridSwitchSheet via QuickPick; CellGridPanel.activeLocalPanels accessor; panel title "Sheet N of M"; V3.2.a seeds sample on sheets 0/1/2).  IDE `dbc2bb517b0`; mocha 167 -> 172 (+5).  V3.3.0.6 mocha tests / V3.3.0.7 docs / V3.3.0.X parallel Codex+Opus audit remain.)
date: 2026-05-22
...
current_engine_head: 2bfba9b55ec (V3.3.0.3 engine exportSnapshot incremental cache; V3.3.0.4 + V3.3.0.5 had no engine changes)
current_ide_head: dbc2bb517b0 (V3.3.0.5 IDE multi-sheet UX command + panel-title sheet count; predecessor 570c890f654 = V3.3.0.4 virtualization)
current_mocha_count: 172 / 172 (V3.2 exit baseline 140 + V3.3.0.2 +5 + V3.3.0.3 +4 + V3.3.0.4 +18 + V3.3.0.5 +5)
