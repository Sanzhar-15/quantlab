...
current_engine_head: e7931a74d0d (V3.6.0.X audit-of-D4 closures: Op::SetDateSystem + DateSystemWire + replay handler + from_qbook seed + Pending skip + locale passthrough + per-snapshot parse cache + 2 regression tests + doc sweep) <- 5b3017c70d2 (V3.6.0.5 D4 engine) <- f6ef41ad732 (V3.6.0.X audit-of-D3 closures) <- 84cb5c9d169 (V3.6.0.4 D3 MASTER-PLAN sweep) <- 119df9b3826 (V3.6.0.4 D3 ship) <- prior chain
current_ide_head: b76b8266beb (V3.6.0.X audit-of-D4 IDE: data-raw-value attribute + beginEdit reads it first + dateSystem TS docstring fix) <- d7cb01557d4 (V3.6.0.5 D4 IDE) <- 21fe6a73ec6 (V3.6.0.X audit-of-D2 IDE typedoc sweep)
current_mocha_count: 354 / 354 (V3.6.0.5 D4 +4 shape pins; V3.6.0.X audit-of-D4 +0 since HIGH-2 data-raw-value test would need DOM/JSDOM harness not in scope; data-raw-value attribute is verified by inspection per Opus B.2)
current_ql_collab_tests: 136 / 136 (V3.6.0.5 D4 +0 engine collab-side; V3.6.0.X audit-of-D4 +2 for Op::SetDateSystem replay arm)
