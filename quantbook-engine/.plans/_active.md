...
current_engine_head: (this commit -- V3.6.0.5 D4 format-aware buildHtml rendering: napi rendered + dateSystem fields + format::render integration in workbook_snapshot) <- f6ef41ad732 (V3.6.0.X audit-of-D3 closures) <- 84cb5c9d169 (V3.6.0.4 D3 MASTER-PLAN sweep) <- 119df9b3826 (V3.6.0.4 D3 ship) <- prior chain
current_ide_head: (this commit -- V3.6.0.5 D4 IDE: types.ts CellSnapshotJson.rendered + WorkbookSnapshotJson.dateSystem + QuantbookCellSnapshot.entries.rendered passthrough + extractSheetSnapshot rendered conditional include + cellGridHtml::renderRows + renderRowsClient rendered-or-fallback wiring + 4 mocha shape tests + 12 fixture updates) <- 21fe6a73ec6 (V3.6.0.X audit-of-D2 IDE typedoc sweep)
current_mocha_count: 354 / 354 (V3.6.0.5 D4 +4 shape pins: dateSystem default + valid-discriminator + rendered-absent-without-format + rendered-not-in-Object.keys-when-absent)
current_ql_collab_tests: 134 / 134 (V3.6.0.5 D4 +0 engine collab-side changes; format::render integration lives in napi crate)
