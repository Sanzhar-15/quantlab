...
7. **(IMMEDIATELY NEXT) — Phase 4.5.A.0** — Introduce `EvalContext` + `ContextAwareFn` registry tier + dispatch wiring. ~1 session, mostly mechanical. Prerequisite for all subsequent date functions.
