...
6. **(IMMEDIATELY NEXT) — Phase 4.5 architectural decision** — Dates / Times / Number Formats. Plan-mode + Codex-reviewed design doc at `docs/architecture/<date>-dates-times-formats.md`. Pin Excel 1900/1904 epoch policy, format parser, locale-sensitive rendering. Use W5-49 design-before-code pattern.
