...
3. **4.3 Function Library Expansion Wave 1 - Core 100** 🔄 IN PROGRESS (V1 batch shipped 2026-05-13, W5-46; FN4-02 backfill W5-48)  
   ...
   **V2 prerequisites (W5-49 decision; SHIPPED W5-50 + W5-52):**
   ...
   Acceptance:  
   - FN4-01 ⚠️ partial — registry at 95 entries (30 pre-W5-46 → 52 after V1 → 59 after W5-51 trig → 61 after W5-53 SUMIF/COUNTIF → 66 after W5-54 lookup family → 71 after W5-55 IFS family + SUMPRODUCT → 81 after W5-56 text wave 2 → 95 after W5-57 math completion + hyperbolic trig); **5 to close FN4-01.**  
   ...
   Remaining to close FN4-01: ~5 more functions. Shipped: trig W5-51, SUMIF/COUNTIF W5-53, lookup family W5-54, IFS family + SUMPRODUCT W5-55, text wave 2 W5-56, math completion + hyperbolic trig W5-57. Remaining: stats family — LARGE/SMALL/RANK/MEDIAN/MODE (range-aware, ~5 fns to close FN4-01 to 100). Bonus: CONCAT (range-aware), PROPER/CLEAN (scalar).  
