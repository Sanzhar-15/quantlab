...
3. **4.3 Function Library Expansion Wave 1 - Core 100** 🔄 IN PROGRESS (V1 batch shipped 2026-05-13, W5-46; FN4-02 backfill W5-48)  
   ...
   **V2 prerequisites (W5-49 decision; SHIPPED W5-50 + W5-52):**
   ...
   Acceptance:  
   - FN4-01 ⚠️ partial — registry at 81 entries (30 pre-W5-46 → 52 after V1 → 59 after W5-51 trig → 61 after W5-53 SUMIF/COUNTIF → 66 after W5-54 lookup family → 71 after W5-55 IFS family + SUMPRODUCT → 81 after W5-56 text wave 2); 100 target requires ~19 more functions.  
   ...
   Remaining to close FN4-01: ~19 more functions. SIN/COS/TAN/ASIN/ACOS/ATAN/ATAN2 shipped W5-51. SUMIF/COUNTIF shipped W5-53. Lookup family (VLOOKUP/HLOOKUP/MATCH/INDEX/CHOOSE) shipped W5-54. IFS family + SUMPRODUCT shipped W5-55. Text wave 2 (LEFT/RIGHT/MID/FIND/SEARCH/SUBSTITUTE/REPLACE/CONCATENATE/REPT/EXACT) shipped W5-56. Remaining: LARGE/SMALL/RANK/MEDIAN/MODE, CEILING/FLOOR/GCD/LCM/MROUND, hyperbolic trig (SINH/COSH/TANH/ASINH/ACOSH/ATANH), CONCAT (range-aware variant), PROPER/CLEAN.  
