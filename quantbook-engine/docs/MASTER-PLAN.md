...
3. **4.3 Function Library Expansion Wave 1 - Core 100** 🔄 IN PROGRESS (V1 batch shipped 2026-05-13, W5-46; FN4-02 backfill W5-48)  
   ...
   **V2 prerequisites (W5-49 decision; SHIPPED W5-50 + W5-52):**
   ...
   Acceptance:  
   - FN4-01 ⚠️ partial — registry at 71 entries (30 pre-W5-46 → 52 after V1 → 59 after W5-51 trig → 61 after W5-53 SUMIF/COUNTIF → 66 after W5-54 lookup family → 71 after W5-55 IFS family + SUMPRODUCT); 100 target requires further batches.  
   ...
   Remaining to close FN4-01: ~29 more functions. SIN/COS/TAN/ASIN/ACOS/ATAN/ATAN2 shipped W5-51. SUMIF/COUNTIF shipped W5-53 via RangeAwareFn infra. VLOOKUP/HLOOKUP/MATCH/INDEX/CHOOSE shipped W5-54 (lookup family). AVERAGEIF/SUMIFS/COUNTIFS/AVERAGEIFS/SUMPRODUCT shipped W5-55 (conditional-aggregate completion). Remaining: LARGE/SMALL/RANK, LEFT/RIGHT/MID/FIND/SEARCH/SUBSTITUTE/REPLACE/CONCAT/CONCATENATE, ROUND/CEILING/FLOOR family completion, more trig (SINH/COSH/TANH/ASINH/ACOSH/ATANH).  
