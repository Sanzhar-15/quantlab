...
status: SUPERSEDED-BY-EXIT-PACKET — Phase 5 V1 COMPLETE 2026-05-19. D-1 steps 1-4 of 8 shipped + audited 2026-05-19/20; steps 5-8 pending. See `docs/phase5/v1-exit-packet.md` (canonical V1 record) + `docs/phase5/d-1-starting-checklist.md` (D-1 step-by-step + audit transcripts). 5.3, 5.5 V2 V2/V3, 5.7, and 5.8 also remain.
date: 2026-05-19
...
| 5.2 | `ql-collab` Core Documents | 1-2 weeks | **🟡 IN PROGRESS** — 5.2.a scaffold (`66a571b30af`); D-2/D-3/D-4 (`1ca19e2fa37`/`e71312d4bcd`/`2f217a2067a`); 5.2.b (`ef056f50bee`); D-1 steps 1-4 of 8 shipped + audited 2026-05-19/20 (`1e383dc9eeb`/`135bbb99f75`/`af803f1a3f2`/`6a4b8b0922f` + per-step audits at `11765c5c48e`/`1f83fd5f9a4`/`9f34eb96a93`/`e97e646270a`). D-1 steps 5-8 pending. |
