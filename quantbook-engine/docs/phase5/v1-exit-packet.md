...
status: ACTIVE — Phase 5 V1 surface complete 2026-05-19. D-1 (FormatId tagged tuple, multi-day) steps 1-4 of 8 shipped + audited 2026-05-19/20; steps 5-8 remain. 5.3, 5.5 V2 V2/V3, 5.7, and 5.8 also remain.
date: 2026-05-19
updated: 2026-05-20 (post-exit-packet additions: 5.6 V2 sweep_presence + D1.a 4-cluster closure + D-1 steps 1-4 + 4 per-step audits)
...
| ID | Decision | Status |
|---|---|---|
| D-1 | `FormatId` → tagged tuple `{ Builtin(u32), Custom(PeerId, u32) }` | 🟡 IN PROGRESS — steps 1-4 of 8 shipped + audited (2026-05-19/20: `1e383dc9eeb`, `135bbb99f75`, `af803f1a3f2`, `6a4b8b0922f` + audits at `9f34eb96a93`, `e97e646270a`). Steps 5-8 pending. |
