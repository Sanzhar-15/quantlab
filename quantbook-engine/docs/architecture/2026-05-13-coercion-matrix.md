...
- `[FUTURE]` — Aspirational behavior; not implemented yet. Gated on a named gap (e.g. UTF-16 text semantics, TA2/COR-02). _(SUMIF/AVERAGEIF shape anchoring — a former example here — landed in w147; GAP-F-06 COUNT provenance landed in w146; FN4-03 lazy IF/IFERROR landed in w142.)_
