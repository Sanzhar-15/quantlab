...
| PEARSON / RSQ / STEYX | ❌ | 0 | Wave 3 | Remaining Wave 3 regression batch: PEARSON (= CORREL, separate fn in IronCalc), RSQ (= CORREL²), STEYX (standard error of predicted y). IronCalc references at `.references/ironcalc/base/src/functions/statistical/pearson.rs` and `correl.rs::fn_steyx`. |
