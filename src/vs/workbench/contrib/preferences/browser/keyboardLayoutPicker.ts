...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in Quantlab in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open Quantlab and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
