...
| Task | Effort | Files |
|------|--------|-------|
| Trust storage (workspace/global) | 1d | `extensions/quantlab/src/core/trust/store.ts` (NEW) |
...
| API integration (Anthropic/OpenAI) | 2d | `extensions/quantlab/src/ai/provider.ts` (NEW) |
