...
| Corporate action detection | 2d | `engine/data/corporate.py` |
...
| L049 | Corporate actions diagnosed correctly |
...
| Position Reconciliation | 4 | ALL |
| Broker Disconnect | 4 | ALL |
| Audit Log | 5 | ALL |
| Fill Reconciliation | 4 | ALL |
| Session Ledger | 4 | ALL |
| Data Provider | 3 | ALL |
| Drift Detection | 4 | ALL |
| Network Connectivity | 3 | ALL |
| Sleep/Wake | 2 | ALL |
...
## Live Trading Test Vectors Summary
...
| Live Trading Safety | L020-L030 | 11 |
| Live Trading Failure | L040-L050 | 11 |
